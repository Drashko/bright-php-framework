...
use src\EventDispatcher\EventDispatcherInterface;
...
class EventDispatcher implements EventDispatcherInterface
{
    ...
    /**
     * Check if an actual event was called
     *
     * @param string|null $eventName
    ...
    {
        if (is_array($value) && isset($value[0]) && $value[0] instanceof Closure && 2 >= count($value)) {
            $value[0] = $value[0]();
